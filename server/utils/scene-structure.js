...
export function normalizeSceneCard(rawScene = {}) {
  ...
  const normalized = {
    ...
    source_context: cleanText(rawScene.source_context || rawScene.sourceContext || rawScene.context_excerpt),
    core_action: cleanText(rawScene.core_action || rawScene.coreAction || rawScene.primary_action),
    selection_reason: cleanText(rawScene.selection_reason || rawScene.selectionReason || rawScene.reason),
